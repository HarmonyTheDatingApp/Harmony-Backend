...
from harmony.resources.apiv1 import UserSettings, ProfileImages, UserProfileSuggestions, UserMatchesApi, UserSwipeUpdate, NotificationFeed, UserProfileView
...
api.add_resource(UserMatchesApi, '/user/matches')
